...
## 다음 턴 즉시 할 일
👉 **Ch 003 H2 신규 작성** (핵심 개념 4 깊게 — TCP/IP·HTTP·DNS·HTTPS)
   - TCP 3-way 핸드셰이크 그림, HTTP 메서드 5종(GET/POST/PUT/DELETE/PATCH), DNS 레코드 7종(A/AAAA/CNAME/MX/NS/TXT/PTR), TLS 1.3 1-RTT 핸드셰이크
