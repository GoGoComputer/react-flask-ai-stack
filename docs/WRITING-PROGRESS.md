...
## 다음 턴 즉시 할 일
👉 **Ch 004 H4 신규 작성** (명령어 카탈로그 — 23개 명령어 표)
   - git init/add/commit/status/log/diff/branch/checkout/switch/restore/merge/rebase/remote/push/pull/fetch/clone/tag/stash/reset/revert/cherry-pick/reflog — 23개를 한 표에 누이고 위험도 색깔(읽기/안전 쓰기/위험 쓰기) 구분.
