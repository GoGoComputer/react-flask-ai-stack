...
## 다음 턴 즉시 할 일
👉 **Ch 006 H5 신규 작성** (데모 — 자경단 셸 30분 시뮬레이션, 실제 한 줄 자동화 실행 검증)
   - 시나리오: 자경단 본인이 화요일 14:00~14:30 — log 분석·파일 청소·자동화 스크립트 5종 시연. 실제 동작: /tmp 임시 폴더에서 find·rg·grep·sed·awk·jq 한 줄 명령어 실제 실행 출력 캡처. 5사고+처방. 30분 압축 시뮬레이션.
