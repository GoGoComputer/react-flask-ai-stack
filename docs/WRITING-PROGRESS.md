...
## 다음 턴 즉시 할 일
👉 **Ch 005 H3 신규 작성** (환경점검 — GitHub 팀·organization 셋업 + protected branch 7체크 + CODEOWNERS 깊이 + Conventional Commits + commitlint·husky)
   - 자경단 GitHub organization 셋업, branch protection 7체크 깊이, CODEOWNERS 글로브 패턴 깊이, commitlint+husky 셋업.
