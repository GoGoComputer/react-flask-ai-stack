...
## 다음 턴 즉시 할 일
👉 **Ch 003 H3 신규 작성** (환경 점검 — 네트워크)
   - 본인 노트북 IP/게이트웨이/DNS 서버, ifconfig·ip addr, /etc/hosts·/etc/resolv.conf, 회사 vs 집 와이파이 차이, 공인 IP(curl ifconfig.me), 회사 프록시
