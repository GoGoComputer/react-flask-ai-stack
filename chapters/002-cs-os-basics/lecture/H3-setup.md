...
## 18.3. 명령 vs 명령 — macOS Linux 변환표 확장판
...
## 18.7. 한 가지 함정 — Apple Silicon 의 미묘한 차이
...
## 18.95. 7개 명령 한 번에 — myinfo alias 미리보기
...
## 18.97. 두 해 후 본인이 만날 풍경 — OS 정보가 진단의 첫 한 페이지
...
## 18.99. 한 가지 더 — `getconf` 와 한도들의 진짜 이름
