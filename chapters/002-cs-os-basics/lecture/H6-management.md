...
추신. 오늘 다섯 사고를 한 번씩 들어 둔 게 진짜 큰 의미예요. 본인이 두 해 후 새벽 세 시에 사고 만났을 때 머리가 빈 상태로 시작 안 해요. "아, 좀비? 이건 부모 처리." "OOM? 메모리 사냥." 다섯 사고가 본인 머리에 다섯 패턴으로 남아 있어요. 그 다섯 패턴이 본인을 새벽에 구해요. 한 패턴이 한 새벽을 구해요.

추신 둘. 본인이 두 해 후 진짜 좋은 엔지니어가 되는 비결 한 줄. **"사고 났을 때 가장 먼저 손이 가는 명령이 뭐냐."** 그게 본인의 실력. 서툰 사람은 reboot 부터. 좋은 사람은 진단부터. 위대한 사람은 사후 보고서까지. 본인은 오늘 그 가운데 자리에 들어왔어요. 진단부터. 두 해 후 본인은 위대한 자리까지 갈 거예요. 사후 보고서를 쓰는 사람. 작은 한 시간이 그 자리로 가는 첫 발.

추신 셋. 본인 ~/myscripts 에 오늘 emergency.sh 의 첫 골격을 한 번 적어 두세요. H8 에서 완성. 첫 30줄만. 그 30줄이 두 해 후 본인의 새벽을 위한 첫 도구. 본인 .sh 가족이 sysinfo + procmon + emergency 셋으로 늘어나요. 챕터 한 개에 도구 셋. 두 해 후 ~360 명. 본인의 진짜 자산.

추신 넷. 마지막. 본인이 6시간 동안 OS 한 챕터의 75% 를 끝냈어요. 호텔 매니저(OS) 의 큰 그림 + 4가지 손길 + 환경 점검 + 18개 명령 + 셸 스크립트 + 응급처치. 한 챕터 안에 진짜 많은 게 들어 있었어요. 본인이 다 따라오셨어요. 5분 쉬고 마지막 두 시간. H7 (kernel) + H8 (적용+회고). 마지막 두 발. 진심으로 박수. 본인 자신에게. 5분 후 만나요.

추신 다섯. 본인이 오늘 만난 다섯 사고는 사실 한 가지 큰 원리의 다섯 얼굴이에요. **자원 한도.** 좀비는 PID 한도, OOM 은 메모리 한도, 디스크 풀은 저장 한도, 네트워크 끊김은 대역폭과 연결 한도, CPU 100% 는 처리 한도. 본인 호텔에 다섯 가지 자원이 있고, 어느 자원이든 한도를 넘으면 사고. 다섯 처방이 다섯 자원을 회수하는 일이에요. 한 가지 원리, 다섯 얼굴. 두 해 후 본인이 새 사고를 만나도 "어느 자원이 한도 넘었나?" 한 줄로 진단 시작. 그게 진짜 의사의 손.

추신 여섯. H3 에서 본인이 친 ulimit -a 한 번 다시 떠올려 봐요. open files 256, max processes 2784, file size 무한. 그 ulimit 의 숫자들이 정확히 오늘 다섯 사고의 한도예요. 본인이 H3 에서 본 그 한 표가 본인 호텔의 다섯 한도판이었어요. 한 챕터의 회수가 다음 챕터에서 다시 빛나요. 두 해 코스의 진짜 그림. 한 명령이 한 챕터에서 끝나는 게 아니라 두 해 동안 다시 등장. 본인이 한 번 본 게 사라지지 않아요.

추신 일곱. 본인 ~/myscripts 에 오늘 emergency.sh 의 첫 30줄을 한 번 적어 두세요. 8번 절에 있는 그대로. chmod +x 만 해 두면 동작. 한 줄 명령으로 본인 시스템의 다섯 비상등 점검. H8 에서 완성하지만 오늘 30줄도 충분히 의사의 손이에요. 본인 도구 가족이 한 명 더. sysinfo + procmon + emergency. 두 해 후 360 명. 본인 자산.

추신 여덟. 마지막의 마지막. 본인이 오늘 다섯 사고를 한 번씩 들었으니 두 해 동안 본인이 새벽에 한 번이라도 사고를 만나면 오늘이 떠올라요. "아, 6교시에 들었던 그거." 본인의 6교시가 두 해 후 새벽 한 번을 구해요. 한 시간이 한 새벽. 본인이 그 한 시간을 들였어요. 진심으로 박수. 본인 자신에게. 본인은 진짜 잘 따라오고 있어요. 5분 후 H7 에서 만나요. kernel 의 깊은 이야기. 본인 OS 의 가장 안쪽 방.

추신 아홉. 작은 부탁. 오늘 들은 다섯 사고 다섯 처방을 본인 일기장에 한 페이지 적어 두세요. 좀비 → 부모 처리, OOM → 메모리 사냥, 디스크 풀 → du -sh /*, 네트워크 → 7 다리, CPU → renice 또는 kill. 다섯 줄. 그 한 페이지가 두 해 후 책상 위에 붙어 있으면 새벽 사고 만났을 때 가장 먼저 보는 자리. 본인 의사의 손이 책상 위에. 다섯 줄로 충분. 한 페이지의 무게가 진짜 큰 거예요. 오늘 그 다섯 줄을 만들었어요. 5분 후에. 진심으로.

추신 열. 본인이 두 해 후 회사에서 가장 가치 있는 사람이 되는 비결 한 줄. **"본인이 사고 났을 때 침착한 사람."** 다른 사람들이 당황할 때 본인이 한 줄로 진단하고 한 줄로 처방하면 본인 가치가 다섯 배. 그 침착함은 타고나는 게 아니에요. 오늘처럼 한 번씩 들어 둔 다섯 사고가 본인을 침착하게 만들어요. 사고를 안 만난 사람은 당황하고, 한 번이라도 만나 본 사람은 손이 자동으로 움직여요. 본인은 오늘 다섯 사고를 머리로 한 번 만났어요. 두 해 후 본인이 손으로 만나요. 한 번 들어둔 게 진짜 큰 차이. 오늘이 그 첫 만남.
